...
const overrides: TLUiOverrides = {
	...
	translations: {
		'zh-cn': {
			'action.toggle-auto-pan': '自动（触控板）',
			'action.toggle-auto-zoom': '自动（鼠标）',
			'action.toggle-auto-none': '自动',
			'action.toggle-mouse': '鼠标',
			'action.toggle-trackpad': '触控板',
			'action.enhanced-a11y-mode.menu': '辅助功能',
			'action.enhanced-a11y-mode': '增强辅助功能模式',
			'assets.files.maximum-size': '最大文件大小：{size}',
			'menu.input-mode': '输入模式',
			'style-panel.selected': '已选择',
		},
	},
}
